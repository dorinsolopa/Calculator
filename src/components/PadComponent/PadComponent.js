...
<button name="CE" onClick={event => this.props.onClick(event.target.name)}>CE</button>
<button name=")"  onClick={event => this.props.onClick(event.target.name)}>)</button>
<button style={{backgroundColor:"#fc0505"}} name="C"  onClick={event => this.props.onClick(event.target.name)}>C</button>
...
<button style={{backgroundColor:"#0c0fe8"}} name="+"  onClick={event => this.props.onClick(event.target.name)}>+</button>
...
<button style={{backgroundColor:"#0ded09"}} name="-"  onClick={event => this.props.onClick(event.target.name)}>-</button>
...
<button  style={{backgroundColor:"#f2ee0a"}}name="×"  onClick={event => this.props.onClick(event.target.name)}>×</button>

<button name="·"  onClick={event => this.props.onClick(event.target.name)}>·</button>
<button name="0"  onClick={event => this.props.onClick(event.target.name)}>0</button>
<button style={{backgroundColor:"#a110a1"}} name="="  onClick={event => this.props.onClick(event.target.name)}>=</button>
<button style={{backgroundColor:"#ad05f5"}} name="÷"  onClick={event => this.props.onClick(event.target.name)}>÷</button>
